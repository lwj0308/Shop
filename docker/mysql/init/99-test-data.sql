...
-- ============================================
-- 三、shop_marketing 库测试数据（从 shop_merchant 拆分）
-- 包含：优惠券模板、满减活动、满减活动商品关联
-- ============================================
USE shop_marketing;

-- -------------------------------------------
-- 3.1 优惠券模板表 coupon（5个优惠券模板）
...
-- -------------------------------------------
-- 3.3 满减活动商品关联表 promotion_product
...
-- ============================================
-- 四、shop_seckill 库测试数据（从 shop_merchant 拆分）
-- 包含：秒杀活动
-- ============================================
USE shop_seckill;

-- -------------------------------------------
-- 4.1 秒杀活动表 seckill_activity（2个秒杀活动）
