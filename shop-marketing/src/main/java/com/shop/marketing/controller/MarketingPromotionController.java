 ...
 * 包含三类接口：
 * 1. 商家端接口（/marketing/promotion/*）：商家管理自己的满减活动，需登录
 * 2. 管理端接口（/marketing/promotion/admin/*）：管理员管理所有满减活动，供 shop-admin 通过 Feign 调用
 * 3. 内部接口（/marketing/promotion/inner/*）：供 shop-order 通过 Feign 调用计算满减优惠，不鉴权
 * </p>
 */
...
public class MarketingPromotionController {
