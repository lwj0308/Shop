 ...
 * 包含三类接口：
 * 1. 商家端接口（/merchant/coupon/*）：商家管理自己的优惠券，需登录
 * 2. 管理端接口（/merchant/coupon/admin/*）：管理员管理所有优惠券，供 shop-admin 通过 Feign 调用
 * 3. 内部接口（/merchant/coupon/inner/*）：供其他微服务通过 Feign 调用，不鉴权
 * </p>
 */
